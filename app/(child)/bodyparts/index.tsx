...
const LEVELS = [
  { id: 1, title: 'Level 1', description: 'Wajah & Kepala', badge: '👀 👃 👄 👂 👩', color: '#00CEC9', shadowColor: '#00B894' },
  { id: 2, title: 'Level 2', description: 'Tangan & Kaki', badge: '✋ 🦶 👆 🚶 ✍️', color: '#FD79A8', shadowColor: '#E84393' },
  { id: 3, title: 'Level 3', description: 'Fungsi Bagian Tubuh', badge: '👂 👀 👃 👄 🧠', color: '#0984E3', shadowColor: '#005691' },
  { id: 4, title: 'Level 4', description: 'Panca Indera', badge: '👀 👂 👃 👅 ✋', color: '#6C5CE7', shadowColor: '#4834D4' },
  { id: 5, title: 'Level 5', description: 'Master Anggota Tubuh', badge: '👀 👃 🖐️ 👂 👄', color: '#FDCB6E', shadowColor: '#E1A100' },
];
...
function LevelCardItem({
  ...
  const handlePress = () => {
    ...
    router.push(`/(child)/bodyparts/${level.id}` as Href);
  };
...
export default function BodyPartsLevelSelect() {
  const router = useRouter();
  ...
  const isLevelUnlocked = (levelId: number) => {
    ...
    return progress.bodyparts[String(levelId - 1)]?.completed === true;
  };

  const getLevelStars = (levelId: number) => {
    if (!progress) return 0;
    return progress.bodyparts[String(levelId)]?.score || 0;
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>🦶 Bagian Tubuh</Text>
      </View>
