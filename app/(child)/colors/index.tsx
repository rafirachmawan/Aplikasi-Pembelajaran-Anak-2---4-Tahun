...
const LEVELS = [
  ...
  { id: 2, title: 'Level 2', description: 'Ungu, Pink, Coklat, Abu, Hitam', badge: '🍇 🌸 🍩 🐘 🖤', color: '#74B9FF', shadowColor: '#0984E3' },
  { id: 3, title: 'Level 3', description: 'Putih, Emas, Perak, Toska, Magenta', badge: '☁️ 👑 🪙 🌊 🌺', color: '#A29BFE', shadowColor: '#6C5CE7' },
  { id: 4, title: 'Level 4', description: 'Warna Benda di Sekitar KITA', badge: '🍎 🍌 🍃 ☁️ 🌹', color: '#00CEC9', shadowColor: '#00B894' },
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>🎨 Kenal Warna</Text>
      </View>
