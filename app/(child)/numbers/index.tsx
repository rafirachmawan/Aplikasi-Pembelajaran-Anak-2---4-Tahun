...
const LEVELS = [
  { id: 1, title: 'Level 1', description: 'Angka 1 sampai 5', badge: '1️⃣ 2️⃣ 3️⃣ 4️⃣ 5️⃣', color: '#00B894', shadowColor: '#00876C' },
  { id: 2, title: 'Level 2', description: 'Angka 6 sampai 10', badge: '6️⃣ 7️⃣ 8️⃣ 9️⃣ 🔟', color: '#0984E3', shadowColor: '#005691' },
  { id: 3, title: 'Level 3', description: 'Hitung Benda 1-5', badge: '🍎 🍎🍎 🍎🍎🍎', color: '#6C5CE7', shadowColor: '#4834D4' },
  { id: 4, title: 'Level 4', description: 'Hitung Benda Banyak 6-10', badge: '🚗 🍬 ⚽ 🐝 ⭐', color: '#FD79A8', shadowColor: '#E84393' },
  { id: 5, title: 'Level 5', description: 'Master Angka & Berhitung', badge: '🏆 🔢 📊 🎉 ✨', color: '#FDCB6E', shadowColor: '#E1A100' },
];
...
function LevelCardItem({
  ...
  const handlePress = () => {
    ...
    router.push(`/(child)/numbers/${level.id}` as Href);
  };
...
export default function NumbersLevelSelect() {
  const router = useRouter();
  ...
  const isLevelUnlocked = (levelId: number) => {
    ...
    return progress.numbers[String(levelId - 1)]?.completed === true;
  };

  const getLevelStars = (levelId: number) => {
    if (!progress) return 0;
    return progress.numbers[String(levelId)]?.score || 0;
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>🔢 Kenal Angka</Text>
      </View>
