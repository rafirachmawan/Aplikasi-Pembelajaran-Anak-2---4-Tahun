...
import numbersData from '@/assets/data/numbers.json';
...
function NumberOptionButton({
  ...
  return (
    ...
    >
      ...
      >
        <Text style={styles.numberOptionText}>{option.label}</Text>
      </Animated.View>
    </Pressable>
  );
}
...
export default function NumberQuestion() {
  ...
  const levelData = numbersData.levels.find((l) => l.id === levelId);
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.finishContainer}>
          ...
          <Text style={styles.finishTitle}>Jago Berhitung!</Text>
      ...
      {feedback === 'correct' && (
        <View style={styles.feedbackOverlay}>
          <View style={styles.feedbackCard}>
            ...
            <Text style={styles.feedbackText}>Hore! Angka Yang Benar! 🎉</Text>
          </View>
        </View>
      )}
      ...
      {feedback === 'wrong' && (
        <View style={styles.feedbackOverlay}>
          <View style={[styles.feedbackCard, { backgroundColor: '#FFEAA7' }]}>
            <Text style={styles.feedbackEmoji}>💪😊</Text>
            <Text style={styles.feedbackTextWrong}>Hitung lagi ya!</Text>
          </View>
        </View>
      )}
    </SafeAreaView>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#E3FDFD' },
  header: {
    flexDirection: 'row',
    alignItems: 'center',
