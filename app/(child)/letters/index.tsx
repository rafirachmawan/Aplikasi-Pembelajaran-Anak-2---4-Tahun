...
const LEVELS = [
  { id: 1, title: 'Level 1', description: 'Huruf A sampai E', badge: '🅰️ 🅱️ 🆒 🇩 🇪', color: '#FDCB6E', shadowColor: '#E1A100' },
  { id: 2, title: 'Level 2', description: 'Huruf F sampai J', badge: '🦩 🐘 🐅 🐟 🦒', color: '#E17055', shadowColor: '#D63031' },
  { id: 3, title: 'Level 3', description: 'Huruf K sampai O', badge: '🐱 🐝 🐒 🐉 🦧', color: '#6C5CE7', shadowColor: '#4834D4' },
  { id: 4, title: 'Level 4', description: 'Huruf P sampai T', badge: '🐧 👑 🦏 🦁 🐢', color: '#00CEC9', shadowColor: '#00B894' },
  { id: 5, title: 'Level 5', description: 'Huruf U sampai Z', badge: '🐍 🎻 🦛 🍦 🦓', color: '#FD79A8', shadowColor: '#E84393' },
];
...
function LevelCardItem({
  ...
  const handlePress = () => {
    ...
    router.push(`/(child)/letters/${level.id}` as Href);
  };
...
export default function LettersLevelSelect() {
  const router = useRouter();
  ...
  const isLevelUnlocked = (levelId: number) => {
    ...
    return progress.letters[String(levelId - 1)]?.completed === true;
  };

  const getLevelStars = (levelId: number) => {
    if (!progress) return 0;
    return progress.letters[String(levelId)]?.score || 0;
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>🔤 Kenal Huruf</Text>
      </View>
