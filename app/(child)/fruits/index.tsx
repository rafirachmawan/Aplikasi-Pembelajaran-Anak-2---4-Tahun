...
const LEVELS = [
  { id: 1, title: 'Level 1', description: 'Buah Favorit Anak-Anak', badge: '🍎 🍌 🍊 🍇 🍉', color: '#FF7675', shadowColor: '#D63031' },
  { id: 2, title: 'Level 2', description: 'Buah Tropis Segar', badge: '🥭 🍑 🍋 🥥 🍈', color: '#FD79A8', shadowColor: '#E84393' },
  { id: 3, title: 'Level 3', description: 'Sayuran Bergizi', badge: '🥕 🥦 🌽 🍅 🍆', color: '#00B894', shadowColor: '#00876C' },
  { id: 4, title: 'Level 4', description: 'Warna Buah & Sayur', badge: '🍌 🥕 🥝 🍆 🍓', color: '#0984E3', shadowColor: '#005691' },
  { id: 5, title: 'Level 5', description: 'Master Buah & Sayur', badge: '🍎 🌽 🍉 🥕 🥥', color: '#FDCB6E', shadowColor: '#E1A100' },
];
...
function LevelCardItem({
  ...
  const handlePress = () => {
    ...
    router.push(`/(child)/fruits/${level.id}` as Href);
  };
...
export default function FruitsLevelSelect() {
  const router = useRouter();
  ...
  const isLevelUnlocked = (levelId: number) => {
    ...
    return progress.fruits[String(levelId - 1)]?.completed === true;
  };

  const getLevelStars = (levelId: number) => {
    if (!progress) return 0;
    return progress.fruits[String(levelId)]?.score || 0;
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>🍎 Buah & Sayur</Text>
      </View>
