...
const LEVELS = [
  { id: 1, title: 'Level 1', description: 'Lingkaran, Persegi, Segitiga, Bintang, Hati', badge: '🔴 🟦 🔺 ⭐ 💖', color: '#6C5CE7', shadowColor: '#4834D4' },
  { id: 2, title: 'Level 2', description: 'Oval, Segi Lima, Bulan, Awan, Segi Enam', badge: '🥚 🔷 🌙 ☁️ 🛑', color: '#FD79A8', shadowColor: '#E84393' },
  { id: 3, title: 'Level 3', description: 'Belah Ketupat, Panah, Plus, Tabung', badge: '🔹 ➡️ ➕ 🛢️ 🍦', color: '#00B894', shadowColor: '#00876C' },
  { id: 4, title: 'Level 4', description: 'Cari Bentuk Benda di Sekitar', badge: '🚴‍♂️ 🪟 🍕 🥚 🍦', color: '#E17055', shadowColor: '#D63031' },
  { id: 5, title: 'Level 5', description: 'Master Bentuk & Pemantapan', badge: '🏆 🔷 ⭐ 💖 🔴', color: '#FDCB6E', shadowColor: '#E1A100' },
];
...
function LevelCardItem({
  ...
  const handlePress = () => {
    ...
    router.push(`/(child)/shapes/${level.id}` as Href);
  };
...
export default function ShapesLevelSelect() {
  const router = useRouter();
  ...
  const isLevelUnlocked = (levelId: number) => {
    ...
    return progress.shapes[String(levelId - 1)]?.completed === true;
  };

  const getLevelStars = (levelId: number) => {
    if (!progress) return 0;
    return progress.shapes[String(levelId)]?.score || 0;
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>🔷 Kenal Bentuk</Text>
      </View>
